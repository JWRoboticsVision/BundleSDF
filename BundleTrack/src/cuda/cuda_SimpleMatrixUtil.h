...
inline __device__ __host__ matNxM<3, 2>::matNxM(const float3 &col0, const float3 &col1)
{
	...
	entries2D[1][0] = col0.y;
	entries2D[1][1] = col1.y;
	entries2D[2][0] = col0.z;
	entries2D[2][1] = col1.z;
}
...
inline __device__ float rotationGeodesicDistance(const float3x3 &R1, const float3x3 &R2)
{
