...
try:
    ...
    raise ImportError(
        "This demo requires utils.py from SuperGlue, please use run_demo.sh to start this script."
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weight",
        type=str,
        default="/mnt/9a72c439-d0a7-45e8-8d20-d7a235d02763/github/LoFTR/weights/outdoor_ds.ckpt",
        help="Path to the checkpoint.",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/bowen/debug/",
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[640, 480],
        help="Resize the input image before running inference. If two numbers, resize to the exact dimensions, if one number, resize the max "
    ...
    parser.add_argument(
        ...
        type=int,
        default=2000,
        help="The max vis_range (please refer to the code).",
    )
    parser.add_argument(
        "--bottom_k",
        type=int,
        default=0,
        help="The min vis_range (please refer to the code).",
    )
    ...
    out = make_matching_plot_fast(
        ...
        color,
        text,
        path=f"{opt.output_dir}/match.png",
        show_keypoints=True,
